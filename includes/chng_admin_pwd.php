...
if ($id) {
    ...
    if(!$result){
      header("Location: ../admin/changepwd.php?error=sqlerror");
      exit();
   }
        ...
        exit();
          ...
          $hashedPwd = password_hash($new_pass, PASSWORD_DEFAULT);
             ...
             if ($result2) {
              ...
              header("Location: ../admin/changepwd.php?changepass=success");
             }
    }
  else{
       header("Location: ../admin/changepwd.php?changepass=failure");
     }
       }
   }
   }
