...
<br><br><br><br><br>
	<div class="main">
		...
		<div id="wrapper" class="w3ls_wrapper w3layouts_wrapper">
			<div id="steps" style="margin: 0px auto; height: 650px;" class="agileits w3_steps">
							...
							<div class="abt-agile-right">
								...
								<ul class="address">
									...
									<li>
										<ul class="address-text">
											<li><b>SEX </b></li>
											<li>: <?php echo $_SESSION['sex']; ?></li>
										</ul>
									</li>
									<!-- <li>
										<ul class="address-text">
											<li><b>NATION<br>ALITY </b></li>
											<li>: <?php echo $_SESSION['nation']; ?></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
											<li><b>HOME<br>TOWN</b></li>
											<li>: <?php echo $_SESSION['hmtown']; ?></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
											<li><b>HOME ADDRESS </b></li>
											<li>: <?php echo $_SESSION['hmaddress']; ?></li>
										</ul>
									</li> -->
								</ul>
							</div>
							...
							<ul class="address">
								...
								<li>
									<ul class="address-text">
										...
										<?php
											$roomId = $_SESSION['room_id'];
											if($hostelId == NULL || $roomId == NULL || $roomNo == NULL){
												$roomType = 'None';
											}
											else {
												$sql = "SELECT * FROM Room WHERE Room_id = '$roomId'";
												...
												if($row = mysqli_fetch_assoc($result)){
													...
													echo "<script type='text/javascript'>alert('Foreign Key Error-roomType!!')</script>";
												}
											}
										 ?>
										<li>: <?php echo $roomType; ?></li>
									</ul>
									<ul class="address-text">
										<li><b>ROOM FLOOR </b></li>
										<?php
											$roomId = $_SESSION['room_id'];
											if($hostelId == NULL || $roomId == NULL || $roomNo == NULL || $roomType == NULL){
												$floor = 'None';
											}
											else {
												$sql = "SELECT * FROM Room WHERE Room_id = '$roomId'";
						...
						<div class="abt-agile">
							...
							<div class="abt-agile-right">
								<?php
									...
									$sql1 = "SELECT * FROM Hostel_Manager WHERE Hostel_id = '$Hid' and Isadmin = '0'";
