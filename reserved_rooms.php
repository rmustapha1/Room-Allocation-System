...
<section class="contact py-5">
	<div class="container">
			<div class="mail_grid_w3l">
				<form action="reserved_rooms.php" method="post">
					<div class="row">
					        <div class="col-md-9"> 
...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM Room WHERE Room_No like '$search_box%' and Hostel_id = '$hostel_id' and Allocated = '0' and Reserve = '1'";
  	...
  	<div class="card-header py-3 px-3">
  		<h6 class="m-0 font-weight-bold text-primary">Reserved Rooms</h6>
  	</div>
  	<div class="card-body"> 
    ...
    <?php
    	...
    	<td><?php echo $row_search['Room_No']; ?></td>
    	<td><?php echo $row_search['Room_type']; ?></td>
    	<td><?php echo $row_search['Floor']; ?></td>
    	<td><div class="btn-cancel">
		<?php echo "<a href='actions/release.php?id=".$row_search['Room_id']."'>Release</a>" ?>
		</div></td>
    </tr>
   </tbody>
<?php }} ?>
...
<div class="container">
<h2 class="heading text-capitalize mb-sm-5 mb-4"> Reserved Rooms </h2>
<?php
   $hostel_id = $_SESSION['hostel_id'];
   $query1 = "SELECT * FROM Room where Hostel_id = '$hostel_id' and Allocated = '0' and Reserve = '1'";
...
?>
  ...
  <div class="card shadow mb-4">
    ...
    <tr>
    	...
    	<td><div class="btn-cancel">
		<?php echo "<a href='actions/release.php?id=".$row1['Room_id']."'>Release</a>" ?>
		</div></td>
    </tr>
    </tbody>
<?php }} ?>
