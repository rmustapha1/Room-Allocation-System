...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM Room WHERE Room_No like '$search_box%' and Hostel_id = '$hostel_id' and Allocated = '0' and Reserve = '0'";
    ...
    <?php
		...
		<?php echo "<a href='actions/reserve.php?id=".$row_search['Room_id']."'>Reserve</a>" ?>
		</div></td>
    </tr>
   </tbody>
<?php }} ?>
...
<?php
   $hostel_id = $_SESSION['hostel_id'];
   $query1 = "SELECT * FROM room where Hostel_id = '$hostel_id' and Allocated = '0' and Reserve = '0'";
...
?>
  ...
  <table class="table table-hover table-bordered" width="100%" cellspacing="0">
    ...
    <tr>
    	...
    	<td><div class="btn-cancel">
		<?php echo "<a href='actions/reserve.php?id=".$row1['Room_id']."'>Reserve</a>" ?>
		</div></td>
    </tr>
    </tbody>
<?php }} ?>
