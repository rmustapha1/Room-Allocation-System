       ...
       <div class="main">
		...
		<div id="wrapper" class="w3ls_wrapper w3layouts_wrapper">
			<div id="steps" style="margin:0 auto; width: 100%" class="agileits w3_steps">
				<form id="formElem" name="formElem" action="includes/chng_inc_pwd.php" method="post" class="w3_form w3l_form_fancy">
          ...
          <legend>CHANGE PASSWORD</legend>
            ...
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="includes/chng_inc_pwd.php" method="POST">
               ...
               <div class="col-md-6">
                    ...
                    <p class="text-inverse text-left"><a href="home.php"><b>Go Back</b></a></p>
                 </div>
            </div>
                </form>
              </div>
